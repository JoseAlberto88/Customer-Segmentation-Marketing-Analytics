...
Average annual income of roughly \$27,600 and the lowest average credit
card balance (\$1,314) among all segments. This group also shows the
widest internal spread in balance (from \$250 up to occasional outliers
near \$6,000), suggesting that while most members carry minimal
balances, a small number carry proportionally heavy debt relative to
their income.

**Segment 2 – “Mainstream Middle” (n = 701, 33% of the sample, the
largest segment)** Average income of about \$73,400 with a moderate
average balance of \$2,086. This is the most “typical” segment in the
sample – middle income, moderate credit card usage, without extreme
...
skewing the average – it’s a genuinely consistent pattern of heavy
credit card usage across the whole segment.
